...
import static tracker.jaya.merak.r.sales.Akses.URL_LIST_DEPO;
import static tracker.jaya.merak.r.sales.Akses.URL_LIST_ITEM;
...
class Proses {
    ...
    String sendGetRequest2() {
        StringBuilder sb = new StringBuilder();
        try {
            URL url = new URL(URL_LIST_ITEM);
            HttpURLConnection con = (HttpURLConnection) url.openConnection();
            BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(con.getInputStream()));
